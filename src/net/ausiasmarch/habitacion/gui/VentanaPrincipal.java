...
public class VentanaPrincipal extends JFrame implements ProbadorAparatos {
    ...
    private CadenaMusica miniCadena;
    private Lampara lucesEntrada, lucesMesa, lucesMueble, lucesSofa, 
                    lucesComedor01, lucesComedor02, lucesMuebleB, lucesMuebleC;
    ...
    private void iniciar() {
        ...
        lucesEntrada = new Lampara(0);
        lucesMesa = new Lampara (1);
        lucesMueble = new Lampara(2);
        lucesMuebleB = new Lampara(3);
        lucesMuebleC = new Lampara(4);
        lucesSofa = new Lampara(7);
        lucesComedor01 = new Lampara(5);
        lucesComedor02 = new Lampara(6);
        ...
        lucesEntrada.setHabitacion(habitacion);
        lucesMesa.setHabitacion(habitacion);
        lucesMueble.setHabitacion(habitacion);
        lucesMuebleB.setHabitacion(habitacion);
        lucesMuebleC.setHabitacion(habitacion);
        lucesSofa.setHabitacion(habitacion);
        lucesComedor01.setHabitacion(habitacion);
        lucesComedor02.setHabitacion(habitacion);
    ...
    private void initComponents() {
        ...
        jPanelVistaGeneral.add(jSlider, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 90, -1, -1));
        ...
        jPanelVistaGeneral.add(habitacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 1010, 640));
    ...
    private void jToggelLucesEntradaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggelLucesEntradaActionPerformed
         ...
         if (lucesEntrada.isEncendida()) { 
            lucesEntrada.apagar();
        } else {
            lucesEntrada.encender();
} 
    ...
    private void jToggelLucesComedor2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggelLucesComedor2ActionPerformed
         if (lucesComedor02.isEncendida()) { 
            lucesComedor02.apagar();
        } else {
            lucesComedor02.encender();
} 
    ...
    private void jToggelLucesComedor1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggelLucesComedor1ActionPerformed
        if (lucesComedor01.isEncendida()) { 
            lucesComedor01.apagar();
        } else {
            lucesComedor01.encender();
} 
    ...
    private void jToggelLucesMuebleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggelLucesMuebleActionPerformed
         ...
         if (lucesMueble.isEncendida()) { 
            lucesMueble.apagar();
        } else {
            lucesMueble.encender();
} 
    ...
    private void jSliderStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jSliderStateChanged
        ...
        if (jSlider.getValue()==0){
            ...
            lucesMuebleB.apagar();
            lucesMuebleC.apagar();
        }else if (jSlider.getValue()==2){
            lucesMuebleB.encender();
            lucesMueble.apagar();
            lucesMuebleC.apagar();
        }else {
            lucesMuebleC.encender();
            lucesMueble.apagar();
            lucesMuebleB.apagar();
        }       
        ...
        for(int i=0; i<=7;i++){
            ...
            lampara.setHabitacion(habitacion);
                    ...
                    switch (i){
                        ...
                        case (2): lucesMueble.encender();
                                  lucesMuebleB.apagar();
                                  lucesMuebleC.apagar();
                                    break;
                        case (3): lucesMuebleB.encender();
                                  lucesMueble.apagar();
                                  lucesMuebleC.apagar();
                                    break;
                        case (4): lucesMuebleC.encender();
                                  lucesMueble.apagar();
                                  lucesMuebleB.apagar();
                                    break;
                    }
        ...
        for(int i=0; i<=7;i++){
            ...
            switch (i){
                case(2):lampara.apagar();
                        ...
                        pausa(20000);
                        miniCadena.stop();
                case(7):bluRay.play("My heart will go on.mp3", "Titanic.png", televisor);
                        pausa(15000);
                        bluRay.stop();
            }
                    lampara.apagar();
